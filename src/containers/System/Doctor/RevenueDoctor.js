...
import './RevenueDoctor.scss';

class RevenueDoctor extends Component {
    constructor(props) {
        super(props);
        this.state = {
            startDate: new Date(),
    ...
    render() {
        ...
        return (
            <div className='manage-revenue-container'>
                ...
                <FormattedMessage id="doctor.revenue-doctor"/>{userInfo.lastName} {userInfo.firstName}
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(RevenueDoctor);
